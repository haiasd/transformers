...
_import_structure = {
    ...
    "file_utils": [],
    "generation": ["GenerationConfig", "TextIteratorStreamer", "TextStreamer","TextBatchIteratorStreamer"],
...
if TYPE_CHECKING:
    ...
    # Generation
    from .generation import GenerationConfig, TextIteratorStreamer, TextStreamer,TextBatchIteratorStreamer
