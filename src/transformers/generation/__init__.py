...
_import_structure = {
    ...
    "streamers": ["TextIteratorStreamer", "TextStreamer","TextBatchIteratorStreamer"],
}
...
if TYPE_CHECKING:
    ...
    from .streamers import TextIteratorStreamer, TextStreamer,TextBatchIteratorStreamer
